  ...
  return (
    <div className='bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[300px]'>
        ...
        <div className='p-3 flex flex-col gap-2 w-full '>
            ...
            <p className='text-slate-500 font-semibold mt-2'>₹{listing.offer?listing.discountPrice.toLocaleString('en-US'):listing.regularPrice.toLocaleString('en-US')}{listing.type==='rent'?' / month':""}</p>
